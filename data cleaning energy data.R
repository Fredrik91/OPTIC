...
energy_18 <- c(9:12) %>% paste0("C:/Users/cvfm9/OneDrive - Loughborough University/OPTIC/Carbon Intensity data/Carbon_Intensity_Data_2018_", .,".csv") %>% map(read_csv)
energy_18 <-do.call(rbind.data.frame, energy_18)
energy_19 <- c(1:2) %>% paste0("C:/Users/cvfm9/OneDrive - Loughborough University/OPTIC/Carbon Intensity data/Carbon_Intensity_Data_2019_", .,".csv") %>% map(read_csv)
...
## write to csv
write_csv(energy,"C:/Users/cvfm9/OneDrive - Loughborough University/OPTIC/carbon intensity data.csv")
